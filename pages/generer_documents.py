...
from functions import css_from_function, background, no_sidebar, css, styled_button, my_style_container
import os
import sys
...
def repasse_simulation_materiel():

    import streamlit as st
    import base64
    from streamlit_extras.switch_page_button import switch_page
    from functions import valeur_tabulees, css_from_function, show, space, mispace, show2, type_menage_fct, aidesMPR, aidesCEE, aidesEDF, tarif
    import plotly.express as px
    import matplotlib.pyplot as plt
    import pandas as pd
    from pv_gis_function import calcul_pvgis
    import os 
    from api_functions import test_connexion_internet
    from streamlit_extras.stylable_container import stylable_container
    from db_functions import update_or_insert_data
